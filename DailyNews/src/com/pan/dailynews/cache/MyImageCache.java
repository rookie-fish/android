...
import com.pan.dailynews.cache.DiskLruCache.Snapshot;
import com.pan.dailynews.utils.MD5Utils;

public class MyImageCache implements ImageCache {

	private String TAG=MyImageCache.this.getClass().getSimpleName();  
